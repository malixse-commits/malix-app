(() => {
 ...
 recipes.push({
  id:'tomatsas-malix',name:'Tomatsås à la Malix',emoji:'🍅',time:30,budget:'low',tags:['vegetariskt','budget','tillbehör','ta-vad-du-har'],
