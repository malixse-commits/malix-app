(() => {
 ...
 if(!recipes.some(r=>r.id==='tomatsas-malix'))recipes.unshift({
 ...
 const search=document.querySelector('#recipeSearch');if(search&&search.value)search.dispatchEvent(new Event('input',{bubbles:true}));
})();