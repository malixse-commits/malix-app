(() => {
  function addRoutine(){
    const form=document.querySelector('#plusShoppingForm');
    ...
    box.querySelector('[data-kitchen-checked]').onclick=()=>{box.querySelector('[data-check-status]').textContent='Klart – nu kan du handla utifrån det du faktiskt behöver.';box.querySelectorAll('input').forEach(x=>x.checked=true)};
  }
  addRoutine();
  document.addEventListener('malix-plus-view-ready',addRoutine);
})();