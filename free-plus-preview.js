(() => {
  ...
  // Gemensamt konto och synkning. Om molnkonfigurationen ännu inte är ifylld
  // fortsätter appen fungera lokalt utan att övriga delar påverkas.
  ...
  setTimeout(()=>loadScript('calm-navigation.js',()=>{loadScript('cleaning-tips.js');loadScript('self-care.js',()=>{loadScript('presence-care.js',()=>loadScript('presence-done.js'));loadScript('sleep-care.js')});loadScript('my-time-mobile.js',()=>loadScript('my-day-summary.js'))}),250);
})();